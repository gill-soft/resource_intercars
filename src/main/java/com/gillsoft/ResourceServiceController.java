...
public class ResourceServiceController extends AbstractResourceService {
	...
	public List<Method> getAvailableMethodsResponse() {
		...
		addMethod(methods, "Return tariffs", Method.SEARCH_TRIP_TARIFFS, MethodType.GET);
		...
		addMethod(methods, "Order/ticket return", Method.ORDER_RETURN_CONFIRM, MethodType.POST);
		addMethod(methods, "Order/ticket print form", Method.ORDER_DOCUMENTS, MethodType.POST);
		return methods;
	}
